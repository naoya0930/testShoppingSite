...
<form action="/shopping/OrderServlet?action=order" method="post">
    <table border="1">
        <tr>
        <td>お名前</td><td>${shipping.shipping_name}</td>
        </tr>
        <tr>
        <td>住所</td><td>${shipping.shipping_address}</td>
        </tr>
        <tr>
        <td>電話番号</td><td>${shipping.shipping_tel}</td>
        </tr>
        <tr>
        <td>e-mail</td><td>${shipping.shipping_email}</td>
        </tr>
    </table><br>
